...
function addmarker(i, d) {
    ...
    var infoWindow = new AMap.InfoWindow({
        content:"<h3><font face=\"微软雅黑\"color=\"#3366FF\">"+(i+1) + "."+ d._name +"</font></h3><img src='upload/"+ d.img +"' width='280' /><hr />Address:"+ d._address + "<br />" + "Price" + d.money+ " yuan",
...
function cloudSearch_CallBack(data) { 
    ...
    for (var i = 0; i < resultNum; i++) {  
        ...
        resultStr += 'Address:' + resultArr[i]._address + '<br/>Price:' + resultArr[i].money + 'Yuan</td></tr></table></div>';
...
<a class="btn btn-info" href="javascript:searchbutton()" style="margin-left:15px;">Search</a>

    <div id="iCenter"></div>
    <div class="demo_box">
        <div id="r_title"><b>Product location:</b></div>
        <div id="result"> </div>
    </div>        
 </div> </div>
